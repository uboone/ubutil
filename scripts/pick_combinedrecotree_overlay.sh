...
then
        ...
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_overlay/run_combinedrecotree_overlay/g" > $FCL
        cat $FCL
        cat wrapper.fcl
...
then
        ...
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_overlay/run_combinedrecotree_run3_overlay/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
...
then
        ...
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_overlay/run_combinedrecotree_run4_overlay/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
