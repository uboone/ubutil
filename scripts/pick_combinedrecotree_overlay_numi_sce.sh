...
TEMPLATE_FHILE="run_combinedrecotree_run1_overlay_numi_sce"
PICKED_FHICL="run_combinedrecotree_run1_overlay_numi_sce"
...
then
        ...
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_run1_overlay_numi_sce/run_combinedrecotree_run1_overlay_numi_sce/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_run1_overlay_numi_sce/run_combinedrecotree_run1_overlay_numi_sce/g" > wrapper.fcl
        cat wrapper.fcl
        PICKED_FHICL="run_combinedrecotree_run1_overlay_numi_sce"
...
then
        ...
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_run1_overlay_numi_sce/run_combinedrecotree_run3_overlay_numi_sce/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_run1_overlay_numi_sce/run_combinedrecotree_run3_overlay_numi_sce/g" > wrapper.fcl
        cat wrapper.fcl
        PICKED_FHICL="run_combinedrecotree_run3_overlay_numi_sce"
...
then
        ...
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_run1_overlay_numi_sce/run_combinedrecotree_run4_overlay_numi/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_run1_overlay_numi_sce/run_combinedrecotree_run4_overlay_numi/g" > wrapper.fcl
        cat wrapper.fcl
        PICKED_FHICL="run_combinedrecotree_run4_overlay_numi"
fi
