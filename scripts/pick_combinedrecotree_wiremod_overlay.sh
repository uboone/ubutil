...
TEMPLATE_FHILE="run_combinedrecotree_wiremod_overlay"
PICKED_FHICL="run_combinedrecotree_wiremod_overlay"
if [ "$run_number" -ge "0003420"  ] && [  "0011048" -ge "$run_number"  ];    # run1 and run 2a run number interval; before full CRT
then
        echo "run run1 fhicl"
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_wiremod_overlay/run_combinedrecotree_wiremod_overlay/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_wiremod_overlay/run_combinedrecotree_wiremod_overlay/g" > wrapper.fcl
        cat wrapper.fcl
        PICKED_FHICL="run_combinedrecotree_wiremod_overlay"
...
then
        ...
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_wiremod_overlay/run_combinedrecotree_run3_normLArPIDWeights_wiremod_overlay/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_wiremod_overlay/run_combinedrecotree_run3_normLArPIDWeights_wiremod_overlay/g" > wrapper.fcl
        cat wrapper.fcl
        PICKED_FHICL="run_combinedrecotree_run3_normLArPIDWeights_wiremod_overlay"
elif [ "$run_number" -ge "13697"  ] && [  "18960" -ge "$run_number"  ];   # run 3
then
        echo "run run3 fhicl"
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_wiremod_overlay/run_combinedrecotree_run3_wiremod_overlay/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_wiremod_overlay/run_combinedrecotree_run3_wiremod_overlay/g" > wrapper.fcl
        cat wrapper.fcl
        PICKED_FHICL="run_combinedrecotree_run3_wiremod_overlay"
elif [ "$run_number" -ge "18961"  ] && [  "0025769" -ge "$run_number"  ];   # run 4 and beyond
then
        echo "run run4 fhicl"
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_wiremod_overlay/run_combinedrecotree_run4_wiremod_overlay/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_wiremod_overlay/run_combinedrecotree_run4_wiremod_overlay/g" > wrapper.fcl
        cat wrapper.fcl
