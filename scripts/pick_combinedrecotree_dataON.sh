...
TEMPLATE_FHILE="run_combinedrecotree_run1_dataON"
PICKED_FHICL="run_combinedrecotree_run1_dataON"
...
then
        ...
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_run1_dataON/run_combinedrecotree_run1_dataON/g" > $FCL
        cat $FCL
        cat wrapper.fcl
...
then
        ...
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_run1_dataON/run_combinedrecotree_run3_normLArPIDWeights_dataON/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_run1_dataON/run_combinedrecotree_run3_normLArPIDWeights_dataON/g" > wrapper.fcl
        cat wrapper.fcl
        PICKED_FHICL="run_combinedrecotree_run3_normLArPIDWeights_dataON"
...
then
        ...
        cat wrapper.fcl
        PICKED_FHICL="run_combinedrecotree_run3_dataON"
elif [ "$run_number" -ge "18961"  ] && [  "0025769" -ge "$run_number"  ];   # run 4 and beyond
then
        echo "run run4 fhicl"
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_run1_dataON/run_combinedrecotree_run4_dataON/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_run1_dataON/run_combinedrecotree_run4_dataON/g" > wrapper.fcl
        cat wrapper.fcl
        PICKED_FHICL="run_combinedrecotree_run4_dataON"
fi
