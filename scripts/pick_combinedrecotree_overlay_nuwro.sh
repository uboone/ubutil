...
TEMPLATE_FHILE="run_combinedrecotree_overlay_nuwro"
PICKED_FHICL="run_combinedrecotree_overlay_nuwro"
if [ "$run_number" -ge "0003420"  ] && [  "0011048" -ge "$run_number"  ];    # run1 and run 2a run number interval; before full CRT
then
        echo "run run1 fhicl"
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_overlay_nuwro/run_combinedrecotree_overlay_nuwro/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_overlay_nuwro/run_combinedrecotree_overlay_nuwro/g" > wrapper.fcl
        cat wrapper.fcl
        PICKED_FHICL="run_combinedrecotree_overlay_nuwro"
...
then
        ...
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_overlay_nuwro/run_combinedrecotree_run3_normLArPIDWeights_overlay_nuwro/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_overlay_nuwro/run_combinedrecotree_run3_normLArPIDWeights_overlay_nuwro/g" > wrapper.fcl
        cat wrapper.fcl
        PICKED_FHICL="run_combinedrecotree_run3_normLArPIDWeights_overlay_nuwro"
elif [ "$run_number" -ge "13697"  ] && [  "18960" -ge "$run_number"  ];   # run 3
then
        echo "run run3 fhicl"
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_overlay_nuwro/run_combinedrecotree_run3_overlay_nuwro/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_overlay_nuwro/run_combinedrecotree_run3_overlay_nuwro/g" > wrapper.fcl
        cat wrapper.fcl
        PICKED_FHICL="run_combinedrecotree_run3_overlay_nuwro"
elif [ "$run_number" -ge "18961"  ] && [  "0025769" -ge "$run_number"  ];   # run 4 and beyond
then
        echo "run run4 fhicl"
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/run_combinedrecotree_overlay_nuwro/run_combinedrecotree_run4_overlay_nuwro/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/run_combinedrecotree_overlay_nuwro/run_combinedrecotree_run4_overlay_nuwro/g" > wrapper.fcl
        cat wrapper.fcl
